# Ur Sandhai — 2-Minute Explainer Video Script

**Track:** AgriTech · **Entry:** Individual · **Target runtime:** 2:00
**Record against:** https://sruthisureshkumar-arch.github.io/ursandhai/

Pacing note: the narration below runs a little over 300 words, closer to a
brisk 165 wpm. Read it out loud once with a stopwatch first — if you're
running long, the easiest lines to trim are marked *(cuttable)*.

Recording tip: screen-record the browser tab directly (Chrome's built-in
screen recording, QuickTime on Mac, or the Xbox Game Bar on Windows both
work), then record narration separately and lay it over the top in any
free editor (CapCut, iMovie, or DaVinci Resolve) so you can re-take lines
without re-doing the screen capture.
...
**Say:**
> "Ur Sandhai. Built for AI for Bharat, AgriTech track. Thank you."
...
| Time | Screen action |
|---|---|
| 0:00 | Load the live demo, let it sit |
| 0:08 | Scroll left column slowly |
| 0:25 | Report a sale → pick crop → photograph price board |
| 0:45 | Check a buyer's offer → type price → click "Is this fair?" |
| 1:05 | Map card → recommendation card → point at trend badge |
| 1:25 | Sell together card |
| 1:40 | Full-page pan, optionally show GitHub tab |
| 1:55 | Hold on title / links |

## Captions note

Since one of the theme tracks is Regional Language AI, it's worth burning
in Tamil captions (or at least the Tamil text already shown on screen)
during the 0:45–1:05 and 1:05–1:25 segments — most editors (CapCut,
Resolve) can auto-caption and you can hand-correct the Tamil lines using
the text already visible in the app.
